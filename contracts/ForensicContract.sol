...
contract ForensicContract {  
  struct CrimeDetails {
    ...
    function addReport(string memory _crime_id, string memory _exhibit_name, string memory _desc, string memory _timestamp, string memory _ipfsHash) public returns(uint) {
        crime.length++;
    ...
    function getPat(uint index) public view returns (string memory, string memory, string memory,string memory, string memory)
    {
